...
class TicketImageData:
    ...
    boarding: str
    price: str
    payment: str = "To‘lov chiqishda"
    status: str = "BRON TASDIQLANGAN"
    demo: bool = False
...
def render_ticket(data: TicketImageData) -> bytes:
    ...
    label(f"Bron {data.booking_code}", (425, 1302), 26, ink, max_width=565)
    label("Chiqishda QR-kodni ko‘rsating.", (425, 1359), 22, muted, max_width=565)
    label("Reysdan 20 daqiqa oldin keling.", (425, 1393), 22, muted, max_width=565)
    if data.demo:
        label("SINOV • HAQIQIY SAFAR UCHUN YAROQSIZ", (425, 1460), 17, "#A15821", True, 565)
    else:
        label("Chiptani saqlang — internetsiz ham ochiladi.", (425, 1460), 17, muted, max_width=565)
    buffer = BytesIO()
